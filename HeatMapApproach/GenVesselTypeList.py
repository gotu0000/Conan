...
SOURCE_DIR_NAME = (config['GEN_TYPE_LIST']['SRC_DIR_NAME'])
fileSuffix = (config['GEN_TYPE_LIST']['FILE_SUFFIX'])
destFileName = (config['GEN_TYPE_LIST']['DEST_FILE_NAME'])
...
for i in fileNameList:
    ...
    if(retVal == c.errNO['SUCCESS']):
        vesselListSets.append(aISDM.get_list_of_unique_type(lAPData))
    else:
